/******************************************************************************
 *  Compilation:  javac BellmanFordSP_T.java
 *  Execution:    java BellmanFordSP_T filename.txt s
 ...
 *  reachable from s.
 *
 *  % java BellmanFordSP_T tinyEWDn.txt 0
 *  0 to 0 ( 0.00)  
 ...
 *
 *  % java BellmanFordSP_T tinyEWDnc.txt 0
 *  4->5  0.35
 *  5->4 -0.66
 *
 *
...
/**
 *  The {@code BellmanFordSP_T} class represents a data type for solving the
 ...
 *  @author Kevin Wayne
 */
public class BellmanFordSP_T {
    private double[] distFrom;               // distTo[v] = distance  of shortest s->v path
    private DirectedEdge[] edgeFrom;         // edgeTo[v] = last edge on shortest s->v path
     ...
     */
    public BellmanFordSP_T(EdgeWeightedDigraph_T G, int s) {
    ...
    /**
     * Unit tests the {@code BellmanFordSP_T} data type.
     *
    ...
    public static void main(String[] args) {
        ...
        BellmanFordSP_T sp = new BellmanFordSP_T(G, t);
        ...
        // print shortest paths
            ...
            for (int v = 0; v < G.V(); v++) {
                if (sp.hasPathFrom(v)) {
                    StdOut.printf("%d to %d (%5.2f)  ", v, t, sp.distFrom(v));
