 ...
 *  @author Kevin Wayne
 */
public class VietnamseDate implements Comparable<VietnamseDate> {
   ...
   /**
     ...
     */
    public VietnamseDate(int day, int month, int year) {
     ...
     * @throws IllegalArgumentException if this date is invalid
     */
    public VietnamseDate(String date) {
     ...
     */
    public VietnamseDate next() {
        if (isValid(day + 1, month, year))    return new VietnamseDate(day + 1, month, year);
        else if (isValid(1, month + 1, year)) return new VietnamseDate(1, month + 1, year);
        else                                  return new VietnamseDate(1, 1, year + 1);
    }
     ...
     */
    public boolean isAfter(VietnamseDate that) {
     ...
     */
    public boolean isBefore(VietnamseDate that) {
        return compareTo(that) < 0;
    }
     ...
     */
    @Override
    public int compareTo(VietnamseDate that) {
    ...
    public boolean equals(Object other) {
        ...
        VietnamseDate that = (VietnamseDate) other;
    ...
    public static void main(String[] args) {
        VietnamseDate today = new VietnamseDate(25, 2, 2004);
        ...
        VietnamseDate birthday = new VietnamseDate(16, 10, 1971);
        StdOut.println(birthday);
        for (int i = 0; i < 10; i++) {
            birthday = birthday.next();
            StdOut.println(birthday);
        }
        VietnamseDate test = new VietnamseDate("8/4/1955");
        StdOut.println(test);
    }
